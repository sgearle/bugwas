This is a modification of version 0.93 of GEMMA, by Xiang Zhou and Matthew Stephens, for use with bugwas. The original README follows, but the DOCUMENTATION, INSTALLATION and USAGE instructions no longer apply.
